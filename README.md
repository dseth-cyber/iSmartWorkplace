...
1. แตก `iSmartWorkplace-3.6.0-Windows-x64.zip` แล้วคัดลอก `iSmartWorkplace.exe` ไปไว้ในตำแหน่งถาวร ไม่ต้องติดตั้ง Python
2. หากใช้งานรุ่นเก่าอยู่ ให้ออกจากโปรแกรมผ่าน Tray ก่อน เปิด EXE รุ่นใหม่เพียงตัวเดียว
