...
1.แตก `iSmartWorkplace-3.6.0-Windows-x64.zip` เครื่องแม่ Server แล้วดับเบิ้ลคลิก iSmartWorkplace-Server.exe ไม่ต้องปิด เปิดทิ้งไว้ แล้วดับเบิ้ลคลิกใช้เลย iSmartWorkplace.exe หรือติดตั้งตัว iSmartWorkplace-Setup (สำหรับแชทในองกรณ์)
